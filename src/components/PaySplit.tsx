  ...
  return (
    <section className="overflow-x-hidden bg-ink py-24 text-white" id="modules">
      <div className="page-wrap">
        ...
        <div className={`grid gap-3 md:grid-cols-5${bare ? '' : ' mt-14'}`}>
          <Reveal className="pay-slide md:col-span-2" variant="fade">
            <div className="pay-block pay-from-left bg-brand">
              <div>
                <p className="pay-num">{copy.payNow}</p>
                <p className="mt-4 px-6 text-sm font-extrabold uppercase tracking-[0.16em]">{copy.payNowNote}</p>
              </div>
            </div>
          </Reveal>
          <Reveal className="pay-slide md:col-span-3" variant="fade" delay={140}>
