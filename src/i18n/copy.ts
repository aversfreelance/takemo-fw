...
export const copies: Record<Locale, Copy> = {
  hu: {
    ...
    footerTag: 'Honlap, tárhely és utána is valaki, aki felveszi. Minehead és Budapest.',
  ...
  en: {
    ...
    footerTag: 'A website, hosting, and someone who picks up afterwards. Minehead and Budapest.',
